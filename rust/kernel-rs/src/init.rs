...
pub fn init_all() {
    unsafe {
        ...
        for i in 0..(IDT_DESC_CNT as usize) {
            ...
            crate::interrupt::idt::idt_register_c(i as u8, crate::interrupt::idt::IDT_INTGATE, entry_fn);
        }
        crate::interrupt::isr::init_idt_table_c();
        crate::interrupt::isr::register_intr_handler_c(0x20, crate::interrupt::isr::clock_interrupt_c);
...
#[unsafe(no_mangle)]
pub extern "C" fn init_all_c() { init_all(); }
