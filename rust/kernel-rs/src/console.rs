...
static mut CONSOLE_LOCK: Lock = Lock {
    ...
    semaphore: crate::sync::semaphore::Semaphore {
        value: 0,
        waiter_head: crate::ds::list::ListHead { next: core::ptr::null_mut(), prev: core::ptr::null_mut() },
    },
    lock_rpt_nr: 0,
};
...
#[unsafe(no_mangle)]
pub extern "C" fn console_init_c() { console_init(); }
#[unsafe(no_mangle)]
pub extern "C" fn console_acquire_c() { console_acquire(); }
#[unsafe(no_mangle)]
pub extern "C" fn console_release_c() { console_release(); }
#[unsafe(no_mangle)]
pub extern "C" fn console_put_str_c(s: *const u8) { console_put_str(s); }
#[unsafe(no_mangle)]
pub extern "C" fn console_put_char_c(c: u8) { console_put_char(c); }
#[unsafe(no_mangle)]
pub extern "C" fn console_put_int_c(num: u32) { console_put_int(num); }
