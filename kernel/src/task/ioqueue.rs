...
use crate::task::thread::{
    TASK_BLOCKED, running_thread, task_struct, thread_block, thread_unblock,
};
...
unsafe fn memset(ptr: *mut u8, val: u8, size: usize) {
    unsafe {
        core::ptr::write_bytes(ptr, val, size);
    }
}
...
#[unsafe(no_mangle)]
pub extern "C" fn ioq_init_c(i: *mut IoQueue) {
    ioq_init(i);
}
#[unsafe(no_mangle)]
pub extern "C" fn ioq_is_empty_c(i: *mut IoQueue) -> i32 {
    ioq_is_empty(i) as i32
}
#[unsafe(no_mangle)]
pub extern "C" fn ioq_is_full_c(i: *mut IoQueue) -> i32 {
    ioq_is_full(i) as i32
}
#[unsafe(no_mangle)]
pub extern "C" fn ioq_getchar_c(i: *mut IoQueue) -> u8 {
    ioq_getchar(i)
}
#[unsafe(no_mangle)]
pub extern "C" fn ioq_putchar_c(c: u8, i: *mut IoQueue) {
    ioq_putchar(c, i)
}
